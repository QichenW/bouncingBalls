...
void DrawLinks::prepareLinks(Part **links) {
    ...
    GLuint torsoObjID = SimpleObjLoader::loadObj(TORSO_OBJ_NAME, 1, 1.0, true, false, false);
    links[0] = new Part(1, torsoObjID, (GLfloat *) NO_VECTOR3, (GLfloat *) NO_VECTOR3, nullptr);
    GLuint thighObjID = SimpleObjLoader::loadObj(THIGH_OBJ_NAME, 2, 1.0, true, false, false);
    ...
    GLuint calfObjID = SimpleObjLoader::loadObj(CALF_OBJ_NAME, 3, 1.0, true, false, false);
    ...
    GLuint footObjID = SimpleObjLoader::loadObj(FOOT_OBJ_NAME, 4, 1.0, true, false, false);
    ...
    GLuint neckObjID = SimpleObjLoader::loadObj(NECK_OBJ_NAME, 5, 1.0, true, false, false);
    links[7] = new Part(8, neckObjID, (GLfloat *) NECK_TRANSLATE_1, (GLfloat *) NECK_TRANSLATE_2, links[0]);

    GLuint headObjID = SimpleObjLoader::loadObj(HEAD_OBJ_NAME, 5, 1.0, true, false, false);
    links[8] = new Part(9, headObjID, (GLfloat *) HEAD_TRANSLATE, (GLfloat *) NO_VECTOR3, links[7]);

    GLuint upperArmObjID = SimpleObjLoader::loadObj(UPPER_ARM_OBJ_NAME, 5, 1.0, true, false, false);
    ...
    GLuint foreArmObjID = SimpleObjLoader::loadObj(FOREARM_OBJ_NAME, 5, 1.0, true, false, false);
    ...
    GLuint fistObjID = SimpleObjLoader::loadObj(FIST_OBJ_NAME, 5, 1.0, true, false, false);
